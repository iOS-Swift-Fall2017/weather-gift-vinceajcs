...
class DetailVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        locationDetail = WeatherDetail(name: locationsArray[currentPage].name,
...
extension DetailVC: CLLocationManagerDelegate {
    ...
    func handleLocationAuthorizationStatus(status: CLAuthorizationStatus) {
        ...
        case .denied:
            showAlertToPrivacySettings(title: "User has not authorized location services",
                      message: "Select 'Settings' below to open device settings and enable location servicse for this app.")
            print("I'm sorry - can't show location. User has not authorized it.")
        case .restricted:
            showAlert(title: "Locations services denied",
                      message: "It may be that parental controls are restricting location use in this app.")
            print("Access denied. Likely parental controls are restricting location services in the app.")
    ...
    func showAlertToPrivacySettings(title: String, message: String) {
        ...
        guard let settingsURL = URL(string: UIApplicationOpenSettingsURLString) else {
            print("Something went wrong getting the URLString")
            return
        }
        
        let settingsAction = UIAlertAction(title: "Settings",
                                           style: .default) { value in
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        geoCoder.reverseGeocodeLocation(currentLocation, completionHandler:
            { placemarks, error in
                ...
                self.locationDetail = WeatherDetail(name: place,
